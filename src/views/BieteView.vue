...
<script>
/* eslint-disable */
import {writeAngebot,login} from '@/main';
...
methods:{
    async createAngebot(){
        ...
        const angebot=
        {"region":this.selectedRegion,"startDate":this.startDate,"dauer":this.dauer,"startTime":this.startTime,
        "title":this.title,"creator":this.user.uid, "category":this.selectedCategory,"price":parseFloat(this.price),"more":this.more,"privat":this.privat}
